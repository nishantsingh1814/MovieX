...
public class GuestStarAdapter extends RecyclerView.Adapter<GuestStarAdapter.CastHolder> {
    ArrayList<GuestStars> mCast;
    LayoutInflater inflater;
    Context mContext;

    public GuestStarAdapter(ArrayList<GuestStars> mCast, Context mContext) {
        this.mCast = mCast;
    ...
    public void onBindViewHolder(CastHolder holder, int position) {
        ...
        GuestStars cast = mCast.get(position);
