...
public class FavouriteTvAdapter extends RecyclerView.Adapter<FavouriteTvAdapter.VerticalWishlistHolder> {
    ...
    public FavouriteTvAdapter(ArrayList<TvShow> movie, Context context) {
        mMovie = movie;
            ...
            public void onClick(final View view) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        Favourite watchList = new Favourite("tv", false, mMovie.get(position).getTvId());
