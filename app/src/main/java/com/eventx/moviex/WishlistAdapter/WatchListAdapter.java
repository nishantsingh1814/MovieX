...
public class WatchListAdapter extends RecyclerView.Adapter<WatchListAdapter.VerticalWishlistHolder> {
    ...
    public WatchListAdapter(ArrayList<Movie> movie, Context context) {
        mMovie = movie;
