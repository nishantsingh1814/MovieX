...
public class RatedTvFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RatedTVAdapter(mShow, getContext());
    ...
    private void fetchData(final int i) {
        ...
        Call<TvResults> movieResultsCall = apiInterface.getRatedTV(accountId, sessionId,i);
        movieResultsCall.enqueue(new Callback<TvResults>() {
            ...
            public void onResponse(Call<TvResults> call, Response<TvResults> response) {
                if (response.isSuccessful()) {
                    Log.i("jkliuy", "onResponse: "+response.message());
            ...
            public void onFailure(Call<TvResults> call, Throwable t) {
                Log.i("jkliuy", "onResponse: "+t.getMessage());
