...
import com.eventx.moviex.favourite.FavouriteMovieFragment;
import com.eventx.moviex.favourite.FavouriteTvFragment;
...
public class RatingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Your Rated Movies");
        ...
        mTablayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tab.getPosition()==0){
                    ...
                    getSupportActionBar().setTitle("Your Rated Tv Shows");
                }
